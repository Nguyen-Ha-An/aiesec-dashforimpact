...
export const fundData: GreenLoopFundData = {
  ...
  projects: [
    ...
    {
      name: 'Nghiên cứu vật liệu từ bã cà phê và rong biển',
      description: 'Hợp tác với đơn vị nghiên cứu vật liệu để thử nghiệm bao bì từ rong biển và bã cà phê cho các sản phẩm tương lai.',
      goalVnd: 45000000,
      raisedVnd: 12800000,
    },
  ],
  weeklyUpdates: [
    ...
    { weekLabel: 'Tuần 25, 2026', note: 'Ký hợp tác thử nghiệm với đơn vị nghiên cứu vật liệu cho dự án bao bì từ rong biển và bã cà phê.' },
